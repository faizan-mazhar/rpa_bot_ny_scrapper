...
class Scrapper:
    ...
    def __init__(self):
        logger.info("[INFO] Opening a browser client.")
        self.news = []
    ...
    def load_news(self):
        logger.info("[INFO]: Loading website")
        ...
        logger.info("[INFO]: Applying section filter for news")
        section_filter = []
        ...
        logger.info("[INFO]: Applying date filter for news")
        self.browser_client.execute_operation(
            [
    ...
    def read_news(self):
        try:
            logger.info("[INFO]: Extracting news from filtered page.")
